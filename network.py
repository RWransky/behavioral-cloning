...
def build_network(n_layers=4, dim=32, input_shape=[80, 260, 3], n_classes=101, shared=0):
    ...
    model.add(Convolution2D(24, 5, 5, border_mode='valid', init='normal', activation=activation))
    model.add(Dropout(0.5))
    model.add(Convolution2D(36, 5, 5, border_mode='valid', init='normal', activation=activation))
    model.add(Dropout(0.5))
    model.add(Convolution2D(48, 5, 5, border_mode='valid', init='normal', activation=activation))
    ...
    model.add(Flatten())
    model.add(Dense(10, init='normal', activation=activation))
    model.add(Dense(10, init='normal', activation=activation))
    model.add(Dense(1))
