...
def build_network(input_shape=[160, 320, 1]):
    ...
    model.add(Convolution2D(24, 5, 5, subsample=(2, 2), border_mode='valid', init='normal', activation=activation, input_shape=(nrows, ncols, nchannels)))
    ...
    model.add(Flatten())
    model.add(Dense(100, init='normal', activation=activation))
    model.add(Dropout(0.4))
    model.add(Dense(50, init='normal', activation=activation))
    model.add(Dense(1))
